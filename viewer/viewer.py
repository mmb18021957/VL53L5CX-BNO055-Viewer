...
class VL53L5CXViewer:
    ...
    def __init__(self, reader):
        ...
        self._ray_update_interval = 0.001  # Sekunden zwischen Updates
    ...
    def _process_frame(
        ...
        if np.any(distances):
            ...
            if self.target_resolution < 8:
                ...
                # Maske: ein Block ist gültig, wenn mindestens 1 Zone gültig war
    ...
    def run(self, host: str = "0.0.0.0", port: int = 8080):
        ...
        try:
            ...
            # Nur SerialReader hat einen Thread
